export const technicalStories = [
  {
    ...
    subtitle: 'The Ah-Ha Moment of Filters Making Deep Learning Understandable and Setting the Stage for LLMs',
    date: '2026-01-04T22:08:52.490Z',
    services: ['AI', 'Computer Vision', 'Interpretability'],
    image: null,
    content: `A deep dive into the original AlexNet paper and how its convolutional filters learned to recognize classical computer vision primitives, providing an interpretable bridge between handcrafted algorithms and end-to-end neural networks.`,
    polished: false
  },
  {
    id: 2,
